...
button_add=Button(root,text="+",padx=41,pady=20,bg="black",fg="white",command=button_add)
button_mul=Button(root,text="x",padx=41,pady=20,bg="black",fg="white",command=button_mul)
...
button_equal=Button(root,text="=",padx=88,pady=20,bg="black",fg="white",command=button_equal)
button_clear=Button(root,text="clear",padx=77,pady=20,bg="black",fg="white",command=button_clear)
